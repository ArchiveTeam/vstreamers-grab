...
Follow the [instructions on the ArchiveTeam wiki](http://archiveteam.org/index.php?title=Warrior) for installing the Warrior, and select the "vStreamers.com" project in the Warrior interface.
...
### For Debian/Ubuntu:
    ...
    pip install seesaw
    su -c "cd /home/archiveteam; git clone https://github.com/ArchiveTeam/vstreamers-grab.git; cd vstreamers-grab; ./get-wget-lua.sh" archiveteam
    screen su -c "cd /home/archiveteam/vstreamers-grab/; run-pipeline pipeline.py --concurrent 2 --address '127.0.0.1' YOURNICKHERE" archiveteam
    [... ctrl+A D to detach ...]
...
**There is a known issue with some packaged versions of rsync. If you get errors during the upload stage, vstreamers-grab will not work with your rsync version.**
...
6. `screen su -c "cd /home/archiveteam/vstreamers-grab/; run-pipeline pipeline.py --concurrent 2 --address '127.0.0.1' YOURNICKHERE" archiveteam`
